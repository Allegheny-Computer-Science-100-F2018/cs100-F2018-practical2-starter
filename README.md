...
# cs100-F2018-practical2-starter

Designed for use with [GitHub Classroom](https://classroom.github.com/), this
repository contains the starter for Practical 2 in Computer Science 100.
...
produce slightly different output. Remember, you are responsible for finding and
fixing all of the bugs in the programr to ensure that it creates output similiar
to the following:
...
Starter](https://github.com/Allegheny-Computer-Science-100-F2018/cs100-F2018-practical2-starter)
